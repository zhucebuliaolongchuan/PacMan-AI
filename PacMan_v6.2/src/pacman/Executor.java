...
//		//run multiple games in batch mode - good for testing.
		int numTrials=20;
		exec.runExperiment(new EvolutionWithoutCrossover(),new StarterGhosts(),numTrials);
//
//
		/*
...
//		exec.runGameTimed(new iterDeepenPacMan(), new StarterGhosts(), visual);
//		exec.runGameTimed(new StarterPacMan(),new StarterGhosts(),visual);exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);
//		//*/
